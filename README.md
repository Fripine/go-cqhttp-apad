...
## 重要信息
尽微薄之力修了一些基础功能的bug，目前能够正常登录以及收发消息，欢迎提交issue。推荐使用AndroidPad协议登录，你可以在 [这里](https://github.com/Fripine/protocol-versions/tree/master/android_pad) 找到对应版本的协议参数文件，更名为6.json后放入./data/versions文件夹中。
