...
func (g *generator) genRouter(routers []Router) {
	...
	g.WriteString("\"github.com/Fripine/go-cqhttp-apad/coolq\"\n")
	g.WriteString("\"github.com/Fripine/go-cqhttp-apad/global\"\n")
	g.WriteString("\"github.com/Fripine/go-cqhttp-apad/pkg/onebot\"\n")
	g.WriteString(")\n\n")
